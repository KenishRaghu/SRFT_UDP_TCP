...
| Sub-test | File          | Size          | Time     | Server Screenshot             | Client Screenshot             |
| -------- | ------------- | ------------- | -------- | ----------------------------- | ----------------------------- |
| Test 1a  | test.txt      | 67 bytes      | 00:00:00 | ![](test1a_text_server.png)   | ![](test1a_text_client.png)   |
| Test 1b  | test_10mb.bin | 10,485,760 B  | 00:00:01 | ![](test1b_binary_server.png) | ![](test1b_binary_client.png) |
...
| File     | Size     | Time                    | Server Screenshot              | Client Screenshot              |
| -------- | -------- | ----------------------- | ------------------------------ | ------------------------------ |
| test.txt | 67 bytes | N/A (handshake aborted) | ![](test2_wrongkey_server.png) | ![](test2_wrongkey_client.png) |
...
| File          | Size         | Time     | Server Screenshot            | Client Screenshot            |
| ------------- | ------------ | -------- | ---------------------------- | ---------------------------- |
| test_10mb.bin | 10,485,760 B | 00:00:01 | ![](test3_tamper_server.png) | ![](test3_tamper_client.png) |

Server output:
```
[ATTACK MODE: tamper] Attack will be applied during transfer.
[ATTACK] Tampered packet #5 (flipped 2 bits in encrypted payload)
...
| File          | Size         | Time     | Server Screenshot            | Client Screenshot            |
| ------------- | ------------ | -------- | ---------------------------- | ---------------------------- |
| test_10mb.bin | 10,485,760 B | 00:00:01 | ![](test4_replay_server.png) | ![](test4_replay_client.png) |

Server output:
```
[ATTACK MODE: replay] Attack will be applied during transfer.
...
| File          | Size         | Time     | Server Screenshot            | Client Screenshot            |
| ------------- | ------------ | -------- | ---------------------------- | ---------------------------- |
| test_10mb.bin | 10,485,760 B | 00:00:01 | ![](test5_inject_server.png) | ![](test5_inject_client.png) |

Server output:
```
[ATTACK MODE: inject] Attack will be applied during transfer.
...
| Machine | Screenshot                |
| ------- | ------------------------- |
| Server  | ![](test6_md5_server.png) |
| Client  | ![](test6_md5_client.png) |
...
| Test    | File          | Size         | Time                    |
| ------- | ------------- | ------------ | ----------------------- |
| Test 1a | test.txt      | 67 bytes     | 00:00:00                |
| Test 1b | test_10mb.bin | 10,485,760 B | 00:00:01                |
| Test 2  | test.txt      | 67 bytes     | N/A (handshake aborted) |
| Test 3  | test_10mb.bin | 10,485,760 B | 00:00:01                |
| Test 4  | test_10mb.bin | 10,485,760 B | 00:00:01                |
| Test 5  | test_10mb.bin | 10,485,760 B | 00:00:01                |
