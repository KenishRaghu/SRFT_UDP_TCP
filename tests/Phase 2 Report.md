...
| Sub-test | File            | Server Screenshot                   | Client Screenshot                   |
| -------- | --------------- | ----------------------------------- | ----------------------------------- |
| Test 1a  | test.txt        | ![](test1a_text_server.png)         | ![](test1a_text_client.png)         |
| Test 1b  | test_10mb.bin   | ![](test1b_binary_server.png)       | ![](test1b_binary_client.png)       |
...
| File        | Server Screenshot              | Client Screenshot              |
| ----------- | ------------------------------ | ------------------------------ |
| test.txt    | ![](test2_wrongkey_server.png) | ![](test2_wrongkey_client.png) |
...
| File            | Server Screenshot            | Client Screenshot            |
| --------------- | ---------------------------- | ---------------------------- |
| test_10mb.bin   | ![](test3_tamper_server.png) | ![](test3_tamper_client.png) |
...
| File            | Server Screenshot            | Client Screenshot            |
| --------------- | ---------------------------- | ---------------------------- |
| test_10mb.bin   | ![](test4_replay_server.png) | ![](test4_replay_client.png) |
...
| File            | Server Screenshot            | Client Screenshot            |
| --------------- | ---------------------------- | ---------------------------- |
| test_10mb.bin   | ![](test5_inject_server.png) | ![](test5_inject_client.png) |
